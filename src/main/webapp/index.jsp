  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    html {
      ...
      scroll-padding-top: 90px; /* FIX #8: avoids sticky header overlap */
    }
    ...
    *:focus-visible {
    ...
    /* FIX #3: Image shimmer loading */
    .product-card .img-wrap {
      position: relative;
      overflow: hidden;
      background: linear-gradient(90deg, var(--surface) 25%, #e8e6e3 50%, var(--surface) 75%);
    ...
    .product-card .img-wrap img.loaded {
      opacity: 1;
      animation: none;
    }
    .product-card .img-wrap img.loaded + .shimmer-overlay { display: none; }
    ...
    .product-card .body .price { font-weight: 700; font-size: 20px; color: var(--primary); }
    ...
    /* FIX #2: Bigger add-to-cart button */
    ...
    .timer-box .num { font-size: 30px; font-weight: 700; line-height: 1.2; letter-spacing: -0.02em; }
    .timer-box .label {
      font-size: 12px;
      opacity: 0.8;
      text-transform: uppercase;
    ...
    .testimonial-card:hover { box-shadow: var(--shadow); border-color: var(--accent-soft); }
    ...
    .footer-grid .brand-col .brand { font-size: 22px; margin-bottom: 12px; }
    ...
    .footer-grid .col h5 { font-weight: 700; font-size: 16px; margin-bottom: 18px; color: var(--primary); }
    ...
    .footer-grid .col ul li a:hover { color: var(--accent); transform: translateX(4px); }
    .footer-bottom {
      text-align: center;
      padding-top: 28px;
      border-top: var(--line);
